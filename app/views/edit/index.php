<div class="d-flex flex-row">
   ...
   <div class="container-fluid d-flex flex-column mt-5" style="margin-left: 26%; flex-grow: 1;">
      ...
      <a href="<?= BASEURL; ?>/petugas/<?= strtolower($data['judul']); ?>"><button class="btn btn-info rounded text-white font-weight-bold p-2 mb-3 mt-3 ml-4" style="width: 10%;">Kembali</button></a>
